...
<template>
  <div class="bg-slate-900/60 border border-slate-800 p-6 rounded-xl shadow-lg relative group transition-all hover:border-slate-700">
    ...
    <!-- CATEGORY -->
    <div class="mb-5">
      <label class="block text-xs font-bold text-[#0068fe] uppercase tracking-wider mb-2">Category *</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <div class="col-span-2">
        <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Item Name *</label>
      ...
      <div>
        <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Price (Optional)</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
      <div>
        <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Dietary Type *</label>
      ...
      <div class="col-span-2">
        <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Description (Optional)</label>
        <input v-model="item.description" type="text" placeholder="Brief description..." class="w-full bg-[#030712] border border-slate-800 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-[#0068fe] transition-colors placeholder-slate-600" />
      </div>
    </div>
